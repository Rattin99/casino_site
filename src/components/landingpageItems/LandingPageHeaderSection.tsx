                ...
                <div className="main-content">
                  <div className="top-area section-text">
                    ...
                    <h2 className="sub-title">
                      Discover exclusive deals on your favorite betting
                      categories
                    </h2>

                    <h6>
                      Explore exclusive offers on casino games, crypto, lottery,
                      and sports betting.Dive into our world of free online
                      games – all without spending a dime!
                    </h6>
                  </div>
                </div>
              </div>
        ...
        <div className="container wow fadeInUp">
          <div className="main-content">
            <div className="row cus-mar custom-space-between-cols">
              ...
              <div
                className="col-lg-4 col-md-4 flash-card mb-3 zoom-on-hover"
              ...
              >
                <div className="single-box d-flex align-items-center text-center">
                  <div className="text-area">
                    <h4 className="sub-title" style={{ marginTop: "15px" }}>
                      Weekly Draw Prizes
                    </h4>
              ...
              >
                <div className="single-box d-flex align-items-center text-center">
                  <div className="text-area">
                    ...
                    <p>
                      Enjoy bonus rewards and special deals reserved just for
                      our players
                    </p>
                  </div>
                </div>
