  ...
  useEffect(() => {
    const handleAriaExpandedChange = () => {
      if (burgerMenuRef.current) {
        const expanded =
          burgerMenuRef.current.getAttribute("aria-expanded") === "true";
      ...
      <html lang="en">
        ...
        <body>
          ...
          <header
            ...
            style={{ zIndex: "99999999999999", position: "relative" }}
          >
              ...
              >
                <div className="container-fluid">
                  ...
                  >
                    ...
                    >
                      <img
                        src="/assets/betsson.png"
                        className="fav d-none d-lg-block d-xl-none"
                        alt="fav"
                      />
                      <img
                        src="/assets/images/betsson.png"
                        style={{ width: "80px" }}
                    ...
                    <ul className="navbar-nav mr-auto mb-2 mb-lg-0 text-center ">
                      ...
                      >
                        <a
                          className={`nav-link ${pathName == "/offers/CasinoOffer" && "active"}`}
                          href="/offers/CasinoOffer"
                        >
                          Offers
                        </a>
                      </li>
