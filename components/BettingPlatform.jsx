  ...
  return (
    <div className="w-full mx-auto py-12">
      ...
      <div className="w-full bg-orange-50 py-12 ">
        <div className="flex flex-col max-w-5xl mx-auto md:flex-row items-center justify-between mb-16">
          {/* Left Side with Image */}
          <div className="w-full  md:w-1/2 mb-8 md:mb-0 flex justify-center">
            <div className="relative rounded-full bg-orange-200 p-8 w-full max-w-md">
              <Image
                src="/meeting.png"
          ...
          <div className="w-full md:w-1/2 space-y-4 ">
            ...
            <p className="text-gray-600 text-sm">
              Safe, secure, and endlessly entertaining. Explore the world of
              free betting at your own pace. Sharpen your skills, experiment
              with strategies, and unlock a world of free betting possibilities.
      ...
      <div className="max-w-5xl mx-auto pt-12 ">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            ...
            games, offers, and features. Sharpen your skills and become a
            betting pro without risking a dime.
          </p>
        </div>
        {/* Features Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600 text-sm">
              Get a vast library of free betting options, exclusive offers, and
              a platform built to hone your skills. It's the ultimate free play
              experience!
            </p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <p className="text-gray-600 text-sm">
              Ditch the endless browsing! We've curated everything you need in
